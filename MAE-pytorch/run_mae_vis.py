...
def get_args():
    ...
    parser.add_argument('--img_path', default='path/to/ImageNet_ILSVRC2012/val/n01440764/ILSVRC2012_val_00000293.JPEG',type=str, help='input image path')
    parser.add_argument('--save_path', default='save/',help='save image path')
    parser.add_argument('--model_path', default='path/to/pretrain/pretrain_mae_vit_base_mask_0.75_400e.pth', help='checkpoint path of model')
